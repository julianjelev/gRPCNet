...
namespace gRPCNet.Client.Infrastructure
{
    ...
    public class DynamicBuffer
    {
        ...
        /// </summary>
        public DynamicBuffer() { Data = new byte[0]; Size = 0; Offset = 0; }
        /// <summary>
        /// Initialize a new expandable buffer with the given capacity
        /// </summary>
        public DynamicBuffer(long capacity) { Data = new byte[capacity]; Size = 0; Offset = 0; }
        /// <summary>
        /// Initialize a new expandable buffer with the given data
        /// </summary>
        public DynamicBuffer(byte[] data) { Data = data; Size = data.Length; Offset = 0; }
