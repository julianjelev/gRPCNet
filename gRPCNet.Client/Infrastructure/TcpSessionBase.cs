...
namespace gRPCNet.Client.Infrastructure
{
    ...
    public class TcpSessionBase : IDisposable
    {
        // Receive buffer
        private bool _receiving;
        private DynamicBuffer _receiveBuffer;
        private SocketAsyncEventArgs _receiveEventArg;
        // Send buffer
        private readonly object _sendLock = new object();
        private bool _sending;
        private DynamicBuffer _sendBufferMain;
        private DynamicBuffer _sendBufferFlush;
        ...
        internal void Connect(Socket socket) 
        {
            ...
            // Setup buffers
            _receiveBuffer = new DynamicBuffer();
            _sendBufferMain = new DynamicBuffer();
            _sendBufferFlush = new DynamicBuffer();
