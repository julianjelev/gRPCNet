...
namespace gRPCNet.Client.Infrastructure
{
    ...
    public class TcpServerBase : IDisposable
    {
        ...
        // Server sessions
        protected readonly ConcurrentDictionary<Guid, TcpSessionBase> Sessions = new ConcurrentDictionary<Guid, TcpSessionBase>();
        ...
        public TcpServerBase(IPAddress address, int port) : 
        ...
        protected virtual TcpSessionBase CreateSession() { return new TcpSessionBase(this); }
        ...
        public TcpSessionBase FindSession(Guid id)
        {
            // Try to find the required session
            return Sessions.TryGetValue(id, out TcpSessionBase result) ? result : null;
        }
        ...
        internal void RegisterSession(TcpSessionBase session)
        {
            // Register a new session
        ...
        {
            // Unregister session by Id
            Sessions.TryRemove(id, out TcpSessionBase temp);
        }
        ...
        protected virtual void OnConnected(TcpSessionBase session) { }
        /// <summary>
        /// Handle session disconnected notification
        /// </summary>
        /// <param name="session">Disconnected session</param>
        protected virtual void OnDisconnected(TcpSessionBase session) { }
        ...
        internal void OnConnectedInternal(TcpSessionBase session) { OnConnected(session); }
        internal void OnDisconnectedInternal(TcpSessionBase session) { OnDisconnected(session); }
